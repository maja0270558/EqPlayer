...
@objc class EQFirebaseManager: NSObject {
    ...
    static func uploadImage(userUID: String, image: UIImage, completion: @escaping (String) -> Void = { _ in return }) {
   ...
   @objc static func postEQProject(projectModel: EQProjectModel) {
