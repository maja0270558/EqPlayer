...
class EQSpotifyManager: NSObject, SPTAudioStreamingPlaybackDelegate, SPTAudioStreamingDelegate, SPTCoreAudioControllerDelegate {
 @objc static let shard: EQSpotifyManager = EQSpotifyManager()
 ...
 @objc let durationObseve = EQPlaybackDurationModel()
  
  @objc var currentSetting = [Double]()
  var loginURL: URL?
  var currentPlayIndex: Int = 0
  var currentPlayingType: EQPlayingType = .none
  @objc var previousPreviewURLString: String = ""
  ...
  func popLoginViewController() {
    ...
    @objc func setCurrentPlayingType(index: Int) {
        switch index {
        case 1:
...
extension EQSpotifyManager {
 ...
 @objc func playOrPause(isPlay: Bool, completion: @escaping () -> Void = {}) {
 ...
 @objc func playPreview(uri: String,
                   duration: Double,
 ...
 @objc func playFromLastDuration() {
